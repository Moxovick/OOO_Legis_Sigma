...
const SUBPAGE_TEXTS: Record<string, string> = {
  // СКУД
  "proektirovanie-skud": "Группа компаний ЛЕГИС представляет услуги по проектированию систем контроля и управления доступом (СКУД). Разрабатываем техническую документацию, подбираем оборудование с учётом требований заказчика и специфики объекта.",
  ...
  "obsluzhivanie-skud": "Компания ЛЕГИС предлагает комплекс услуг по техническому обслуживанию и ремонту СКУД. Обеспечиваем бесперебойную работу систем контроля доступа.",
      ...
      <main>
        ...
        <section className="section no-overlap overflow-hidden">
          <div className="wrapper">
            ...
            <div style={{ marginTop: "2rem" }}>
              {[
                { q: `Что входит в услугу «${pageTitle}»?`, a: `Услуга включает все необходимые работы: от консультации и обследования объекта до монтажа и пуско-наладки. Специалисты ЛЕГИС-ТЕХ подберут оптимальное решение под ваши задачи.` },
